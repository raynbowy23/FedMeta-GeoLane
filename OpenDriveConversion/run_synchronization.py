...
class SimulationSynchronization(object):
    ...
    def tick(self):
        ...
        # if vehicles:
        #     vehicle = vehicles[0]  # Pick first available vehicle
        #     location = vehicle.get_location()
            
        #     print(f"Moving camera to vehicle at {location}")
            
        #     # Move spectator above the vehicle (adjust height)
        #     spectator.set_transform(self.carla.Transform(
        #         location + self.carla.Location(z=10),  # Move 10m above for a clear view
        #         self.carla.Rotation(pitch=-30)  # Slight downward angle
        #     ))
        # else:
